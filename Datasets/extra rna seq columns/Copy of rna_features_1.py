...
#----------import rna dataset 1------------------------------#

#     GSE227375_norm_counts_STAR

expression_ds=pd.read_csv(r"C:\Users\harry\Desktop\GSE227375_norm_counts_STAR.csv")
...
#  Map UIDS with ENSG
#------------------------------------------------------------------#
map_ds=pd.read_csv(r"C:\Users\harry\UID_to_ENSBL_mapping.csv", usecols=['uid', 'ID'])
...
test_uids['GSE227375_spearman'] =calc_list
