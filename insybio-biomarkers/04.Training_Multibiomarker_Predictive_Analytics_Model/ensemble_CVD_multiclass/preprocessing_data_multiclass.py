...
def parsing(dataset_filename, labels_filename, delimiter_dataset, delimiter_labels):
    ...
    logging.info("Dataset file was successfully parsed inside preprocessing!")
    ...
    logging.info("Labels file was successfully parsed inside preprocessing!")
...
def splitter_multiclass(dataset, labels, labelsnames, features, samples, filtering_percentage, output_folder, user, jobid, pid):
    """
    ...
    for i in range(len(labelsnames)):
        if keep_list[i] == 1:
            final_labels.append(labelsnames[i])
    ...
    for i in range(len(labels)):
        if keep_list[i] == 0:
            final_training_labels.append(labelsnames[i])
...
def main():
    ...
    splitter_multiclass(dataset_filename, labels_filename, filtering_percentage, output_folder)"""
